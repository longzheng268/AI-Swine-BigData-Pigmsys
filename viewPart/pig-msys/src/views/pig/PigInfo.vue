  ...
  <div>
    ...
    >
      ...
      <el-form-item label="猪的种类" size="small" prop="pigType">
        <el-select
          v-model="searchWhere.pigType"
          placeholder="猪的种类"
          style="width: 120px"
        >
          <el-option
            v-for="option in pigTypeOptions"
            :label="option.name"
            :value="option.type"
            :key="option.type"
          ></el-option>
      ...
      <el-form-item label="雄|雌" size="small" prop="pinSex">
        <el-select
          v-model="searchWhere.pinSex"
          placeholder="猪的雄雌"
          style="width: 120px"
        >
          <el-option
            v-for="option in pigSexOptions"
            :label="option.sex"
            :value="option.type"
            :key="option.type"
          ></el-option>
      ...
      <el-form-item size="small">
        ...
        <el-button
          ...
          >重置</el-button
        >
        <el-button type="warning" plain class="el-icon-plus" @click="addHandler"
          >新增</el-button
        >
      </el-form-item>
    </el-form>
    <el-table :data="pigInfoList" style="width: 100%" max-height="500">
      <el-table-column fixed type="index" label="序号" width="60">
      </el-table-column>
      <el-table-column prop="pigisbn" label="小猪编号" width="150">
      </el-table-column>
      <el-table-column prop="pigname" label="小猪名称" width="100">
      </el-table-column>
      <el-table-column prop="pigage" label="小猪年龄" width="100">
      </el-table-column>
      <el-table-column prop="pinsex" label="小猪性别" width="100">
        <template #default="scope">
          <span>{{ pigSexFilter(scope.row.pinsex) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="manufacturedate" label="出生日期" width="200">
      </el-table-column>
      <el-table-column prop="pigaddress" label="生产地" width="200">
      </el-table-column>
      <el-table-column prop="pigimage" label="图片链接" width="100">
        <template #default="scope">
          <img :src="scope.row.pigimage" width="100px" height="100px" />
        </template>
      </el-table-column>
      <el-table-column prop="pigtype" label="小猪种类" width="100">
        <template #default="scope">
