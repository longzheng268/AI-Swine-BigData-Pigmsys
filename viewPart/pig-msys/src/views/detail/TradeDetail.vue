<template>
  <div>
    <div ref="chartDemodiv" style="width: 100%;height: 500px;margin-top: 50px"></div>
  </div>
</template>
    ...
    drawLine(){
      ...
      try {
        ...
        option.series = (option.series || [])
          ...
          .map(item => ({
            ...item,
            type: item.type || 'scatter' // 确保 type 总是存在
          }))
            ...
            try {
              ...
              try {
                ...
                if (currentOption && currentOption.series) {
                  ...
                  if (validSeries.length > 0 && validSeries.length !== allSeries.length) {
                    // 重新设置配置
