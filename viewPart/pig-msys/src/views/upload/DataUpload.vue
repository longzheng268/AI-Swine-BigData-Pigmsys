  ...
  <div class="upload-container">
    ...
    <el-card class="upload-card">
      ...
      >
        ...
        <div class="el-upload__text" v-else>正在上传，请稍候...</div>
        <template #tip>
          <div class="el-upload__tip">
            只能上传 Excel 文件（.xlsx 或 .xls），且不超过 10MB
          </div>
        </template>
      </el-upload>
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-table :data="recordList" border stripe>
        ...
        <el-table-column label="操作" width="100">
          <template #default="scope">
            <el-button size="small" link @click="handleViewDetail(scope.row)"
              >详情</el-button
            >
          </template>
        </el-table-column>
    ...
    <el-dialog title="上传详情" v-model="detailDialogVisible" width="600px">
      <el-descriptions :column="1" border v-if="currentRecord">
        ...
        <el-descriptions-item label="数据类型">{{
          currentRecord.dataType
        }}</el-descriptions-item>
        <el-descriptions-item label="上传人">{{
          currentRecord.uploadUsername
        }}</el-descriptions-item>
        ...
        <el-descriptions-item label="成功数量">{{
          currentRecord.successCount
        }}</el-descriptions-item>
        <el-descriptions-item label="失败数量">{{
          currentRecord.failedCount
        }}</el-descriptions-item>
