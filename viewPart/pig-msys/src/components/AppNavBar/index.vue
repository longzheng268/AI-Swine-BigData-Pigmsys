  ...
  <div class="navbar">
    <!--:router="true" 默认是false 当开启路由时 index的含义变了,原来是代表点哪里哪里亮,现在代表路由-->
      <el-menu
        ...
        <el-menu-item index="/big-screen" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important;">
...
<script>
import { House, FullScreen, Platform, Reading, DataLine, Cpu, User, UserFilled } from '@element-plus/icons-vue'
      ...
      try {
        ...
        if (process.env.NODE_ENV === 'development') {
          console.log('👤 当前用户角色:', {
            ...
            roleName: this.userRole === 1 ? '管理员' : this.userRole === 3 ? '科研人员' : '普通用户',
