...
# 下载JDK 8
cd /opt
sudo wget https://download.java.net/java/GA/jdk8u312-b07/0df1f8a8e3e04a2b68f6e24f34b0d74e/openjdk-8u312-b07-linux-x64.tar.gz

# 解压
sudo tar -xzf openjdk-8u312-b07-linux-x64.tar.gz
sudo mv jdk8u312-b07 jdk1.8
...
- [ ] 网络连接正常，可以ping通外网
- [ ] Java环境安装成功（java -version）
- [ ] MySQL服务运行正常（systemctl status mariadb）
- [ ] Maven安装成功（mvn -version）
- [ ] Node.js和npm安装成功（node -v, npm -v）
- [ ] Python3和pip3安装成功（python3 --version）
- [ ] SSH服务运行正常
- [ ] 系统时间同步正常
