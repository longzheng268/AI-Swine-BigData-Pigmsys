...
### 🖥️ 数据大屏与智能看板
> 实时监控养殖场环境指标、猪只分布及生长趋势预测，支持 ECharts 动态交互。
![数据大屏](./images/data-visual-dashboard.jpg)

### 📊 智能预测与方案对比
> 纯前端 JavaScript 实现的预测算法，支持多套饲养方案的增重效果直观对比，毫秒级响应。
![方案对比](./images/prediction-comparison.jpg)

### 🐷 信息管理与安全认证
> 完善的 CRUD 功能与基于 JWT 的角色权限管理系统。
![生猪管理](./images/swine-management.jpg)
![用户管理](./images/user-management.jpg)
![登录页](./images/login-page.jpg)
## 🚀 技术栈
